...
class PI(object):
    ...
    def __init__(self, sampletime, kp, ki, out_min=float('-inf'),out_max=float('inf'), time=time):
        if kp is None:
            raise ValueError('kp must be specified')
        if ki is None:
            raise ValueError('ki must be specified')        
...
class PD(object):
    ...
    def __init__(self, sampletime, kp, kd, out_min=float('-inf'),
                 out_max=float('inf'), time=time):
        if kp is None:
            raise ValueError('kp must be specified')
        if kd is None:
...
class P(object):
    ...
    def __init__(self, sampletime, kp, out_min=float('-inf'),
                 out_max=float('inf'), time=time):
        if kp is None:
            raise ValueError('kp must be specified')
        if sampletime <= 0:
